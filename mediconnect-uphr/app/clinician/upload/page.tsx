...
function UploadRecord() {
  ...
  const submit = async () => {
    ...
    setSubmitting(true); setError(''); setMessage(''); setImagingOutput(null)
    ...
    try {
      ...
      if (result.imagingOutput?.analysis && result.imagingOutput?.disclaimer) setImagingOutput(result.imagingOutput)
